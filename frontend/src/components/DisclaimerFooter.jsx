...
export default function DisclaimerFooter({ setActiveTab }) {
  ...
  return (
    <footer className="mt-12 px-6 md:px-10 pb-12">
      <div className="max-w-3xl mx-auto rounded-3xl bg-slate-900/40 border border-slate-800 p-6 md:p-8">
        ...
        <p className="text-xs text-slate-500 leading-relaxed">
          Panko is provided <strong className="text-slate-600">"as is"</strong> by <strong className="text-slate-600">Panko Financial Strategies LLC</strong> for educational and informational purposes only. It is not investment advice, brokerage, or fiduciary service. Panko Financial Strategies LLC is <strong className="text-slate-600">not a registered investment adviser</strong> under the Investment Advisers Act of 1940. Numbers are computed from historical price data — <strong className="text-slate-600">past performance does not guarantee future results</strong>. Forward-looking projections are mathematical models, not forecasts. All investing carries risk of loss including loss of principal. The operator accepts no liability for losses, gains, taxes, or decisions made based on this tool's output. <strong className="text-slate-600">Consult a licensed financial advisor before making investment decisions.</strong>
        </p>
        {setActiveTab && (
